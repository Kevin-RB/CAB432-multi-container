...
Disclaimer:
> To upload receipts, please log in with your Google account. Users from external providers have been granted upload permissions.
>
> Note: There is a minor bug that may prevent file uploads right after your first Google login. To properly load your permissions, simply log out and log back in, this should fix the issue!
